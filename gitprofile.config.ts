  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['RobertoReale/polimi-oracle-may-2026-', 'RobertoReale/YT-Transcript-Summarizer', 'RobertoReale/Voice-Message-Transcriber', 'RobertoReale/travel-search', 'RobertoReale/blog-builder', 'RobertoReale/C-code-style-converter'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: '',
